...
public class Mesto1Test {
    ...
    String bearerToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2M2VjYjE0MDViMDU4ODAwM2RlNjk2YmYiLCJp" +
            "YXQiOjE2ODA5Njk1ODIsImV4cCI6MTY4MTU3NDM4Mn0._NjvN1o90S0fY9hy_w0YwYW3l04yCorV8jw1gI31Uq0";
    ...
    public void addNewPhoto() {
        given()
                ...
                .body("{\"name\":\"Москва\",\"link\":\"https://code.s3.yandex.net/qa-automation-engineer" +
                        "/java/files/paid-track/sprint1/photoSelenium.jpg\"}") // Формируем тело запроса
